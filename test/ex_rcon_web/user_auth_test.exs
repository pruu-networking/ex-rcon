defmodule ExRconWeb.UserAuthTest do
  use ExRconWeb.ConnCase, async: true

  alias Phoenix.LiveView
  alias ExRcon.Accounts
  alias ExRconWeb.UserAuth
  import ExRcon.AccountsFixtures
  ...
  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, ExRconWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_user/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      ExRconWeb.Endpoint.subscribe(live_socket_id)
